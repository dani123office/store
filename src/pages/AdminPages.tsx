  ...
  return (
    <div>
      ...
      <div className="bg-white border border-[#e0e0e0] rounded-lg overflow-x-auto">
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-[#fafafa]">
              ...
              <th className="text-left py-3 px-5 text-xs font-medium text-[#6d7175] uppercase">SEO URL</th>
              <th className="text-center py-3 px-5 text-xs font-medium text-[#6d7175] uppercase">Visible</th>
          ...
          <tbody>
            {filtered.map((item) => (
              <tr key={item.id} className="border-t border-[#e0e0e0] hover:bg-[#fafafa]">
                ...
                <td className="py-3 px-5 text-[#6d7175]">{item.SEOurl || "—"}</td>
        ...
        {filtered.length === 0 && (
          <p className="text-sm text-[#6d7175] p-6 text-center">No pages found.</p>
        )}
      </div>
